/***************************************************************************************
   ...
   main heaser for usb for C8051F380 based module
   FILE: usb_main.h
   Supported IC : Si468x
   Date: June 20 2014
...
#define DATA_PATH_REGISTER_BANK 1
#define USB_REGISTER_BANK 2
#define LED_REGISTER_BANK 3
...
void Handle_In3(void);                       // Handle in packet on Endpoint 3
...
// Command Interpretter Routines
//void Radio_Flasher(void);
...
void Turn_On_Stream(void);
void Turn_Off_Stream(void);
